...
H3NB=function(_NativeBaseComponent){_inherits(H3NB,_NativeBaseComponent);function H3NB(){_classCallCheck(this,H3NB);return _possibleConstructorReturn(this,(H3NB.__proto__||Object.getPrototypeOf(H3NB)).apply(this,arguments));}_createClass(H3NB,[{key:'prepareRootProps',value:function prepareRootProps()
