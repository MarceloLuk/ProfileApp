...
TextNB=function(_NativeBaseComponent){_inherits(TextNB,_NativeBaseComponent);function TextNB(){_classCallCheck(this,TextNB);return _possibleConstructorReturn(this,(TextNB.__proto__||Object.getPrototypeOf(TextNB)).apply(this,arguments));}_createClass(TextNB,[{key:'prepareRootProps',value:function prepareRootProps()
...
{var _this2=this;
return(
_react2.default.createElement(_reactNative.Text,_extends({ref:function ref(c){return _this2._root=c;}},this.prepareRootProps()),this.props.children));
