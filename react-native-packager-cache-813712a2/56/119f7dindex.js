...
H1NB=function(_NativeBaseComponent){_inherits(H1NB,_NativeBaseComponent);function H1NB(){_classCallCheck(this,H1NB);return _possibleConstructorReturn(this,(H1NB.__proto__||Object.getPrototypeOf(H1NB)).apply(this,arguments));}_createClass(H1NB,[{key:'prepareRootProps',value:function prepareRootProps()
