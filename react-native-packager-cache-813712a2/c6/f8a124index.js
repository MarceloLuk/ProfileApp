...
{var _this2=this;
return(
_react2.default.createElement(_reactNative.View,_extends({ref:function ref(c){return _this2._root=c;},style:{padding:this.props.padder?this.getTheme().contentPadding:0,flex:1}},this.props)));
